...
{   
    ...
    // std::cout << "Input sent to kernel: ";
    // for(uint32_t i = 0; i < (cptr->size); i++) {
    //     std::cout << input_to_fpga[i];
    // }
    // std::cout << "\n";
    
    // std::cout << "Input size to fpga: " << cptr->size + 1 << "\n";
    ...
    // uint32_t* ptr_output_size = &*ptr_output_size;
